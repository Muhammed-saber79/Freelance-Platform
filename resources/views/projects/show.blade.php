<x-front-layout title="Project Details">
        <!-- Titlebar
================================================== -->
                ...
                <div class="popup-tab-content" id="tab">
                    ...
                    <form method="post" action="{{ route('freelancer.proposals.store', $project->id) }}" id="apply-now-form">
                        ...
                        <div class="input-with-icon-left">
                            ...
                            <x-form.textarea class="input-text with-border" field="description" id="description" placeholder="Proppsal" required="required" />
                        </div>

                        <div class="input-with-icon-left">
                            <i class="icon-material-baseline-mail-outline"></i>
                            <x-form.input type="number" class="input-text with-border" value="" field="cost" id="cost" placeholder="Cost" required="required" />
                        </div>

                        <div class="input-with-icon-left">
                            <i class="icon-material-baseline-mail-outline"></i>
                            <x-form.input type="number" class="input-text with-border" value="" field="duration" id="duration" placeholder="Duration" required="required" />
                            <x-form.select class="input-text with-border" value="" name="duration_unit" id="duration_unit" required="required" :options="$units" />
                        </div>
