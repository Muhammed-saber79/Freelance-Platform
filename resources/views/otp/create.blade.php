        ...
        <div class="row">
            <div class="col-xl-5 offset-xl-3">
                ...
                <div class="login-register-page">
                    ...
                    <!-- Form -->
                    <form method="post" action="{{ route('otp.create') }}" id="login-form">
                        @csrf

                        <div class="input-with-icon-left">
                            <i class="icon-material-outline-mobile"></i>
                            <input type="text" class="input-text with-border" name="mobile_number" id="mobile_number" placeholder="{{ __('Mobile Number') }}" required />
                        </div>
                    </form>
